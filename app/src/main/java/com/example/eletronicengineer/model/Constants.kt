    ...
    class HttpUrlPath {
        ...
        class My{
            companion object{
                ...
                const val deletePersonRequirementInformationCheckByIdIssuer="PersonRequirementInformationCheck/deleteByIdIssuer/{id}"
                //需求团队
                const val deleteRequirementTeamLoggingCheck= "RequirementTeamLoggingCheck/deleteRequirementTeamLoggingCheck/{id}"
                const val deleteRequirementTeamLoggingCheckByIdIssuer= "RequirementTeamLoggingCheck/deleteByIdIssuer/{id}"
                //车辆租赁
                const val deleteLeaseLoggingCheckController = "LeaseLoggingCheck/deleteLeaseLoggingCheckController/{id}"
                const val deleteLeaseLoggingCheckControllerByIdIssuer = "LeaseLoggingCheck/deleteByIdIssuer/{id}"
                //需求三方
                const val deleteRequirementThirdLoggingCheck="RequirementThirdLoggingCheck/deleteRequirementThirdLoggingCheck/{id}"
                const val deleteRequirementThirdLoggingCheckByIdIssuer="RequirementThirdLoggingCheck/deleteByIdIssuer/{id}"
