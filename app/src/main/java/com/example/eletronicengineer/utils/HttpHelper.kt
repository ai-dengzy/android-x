 ...
 */
    ...
    @DELETE(Constants.HttpUrlPath.My.deletePersonRequirementInformationCheckByIdIssuer)
    fun deletePersonRequirementInformationCheckByIdIssuer(@Path("id") id:String):Observable<ResponseBody>
    ...
    @DELETE(Constants.HttpUrlPath.My.deleteRequirementTeamLoggingCheckByIdIssuer)
    fun deleteRequirementTeamLoggingCheckByIdIssuer(@Path("id") id:String):Observable<ResponseBody>
    ...
    @DELETE(Constants.HttpUrlPath.My.deleteLeaseLoggingCheckControllerByIdIssuer)
    fun deleteLeaseLoggingCheckControllerByIdIssuer(@Path("id") id:String):Observable<ResponseBody>
    ...
    @DELETE(Constants.HttpUrlPath.My.deleteRequirementThirdLoggingCheckByIdIssuer)
    fun deleteRequirementThirdLoggingCheckByIdIssuer(@Path("id") id:String):Observable<ResponseBody>

    @DELETE(Constants.HttpUrlPath.My.deleteIndustryYellowPages)
    fun deleteIndustryYellowPages(@Path("id") id:String):Observable<ResponseBody>
...
internal fun deletePersonRequirementInformationCheckByIdIssuer(id:String):Observable<ResponseBody>{
    val interceptor = Interceptor {
        it.proceed(it.request().newBuilder().addHeader("zouxiaodong",UnSerializeDataBase.userToken).build())
    }
    val client = OkHttpClient.Builder().addInterceptor(interceptor).build()
    val retrofit =  Retrofit.Builder().client(client).baseUrl(UnSerializeDataBase.dmsBasePath).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build()
    val httpHelper = retrofit.create(HttpHelper::class.java)
    return httpHelper.deletePersonRequirementInformationCheckByIdIssuer(id)
}
//团队
...
internal fun deleteRequirementTeamLoggingCheckByIdIssuer(id:String):Observable<ResponseBody>{
    val interceptor = Interceptor {
        it.proceed(it.request().newBuilder().addHeader("zouxiaodong",UnSerializeDataBase.userToken).build())
    }
    val client = OkHttpClient.Builder().addInterceptor(interceptor).build()
    val retrofit =  Retrofit.Builder().client(client).baseUrl(UnSerializeDataBase.dmsBasePath).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build()
    val httpHelper = retrofit.create(HttpHelper::class.java)
    return httpHelper.deleteRequirementTeamLoggingCheckByIdIssuer(id)
}
...
internal fun deleteLeaseLoggingCheckControllerByIdIssuer(id:String):Observable<ResponseBody>{
    val interceptor = Interceptor {
        it.proceed(it.request().newBuilder().addHeader("zouxiaodong",UnSerializeDataBase.userToken).build())
    }
    val client = OkHttpClient.Builder().addInterceptor(interceptor).build()
    val retrofit =  Retrofit.Builder().client(client).baseUrl(UnSerializeDataBase.dmsBasePath).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build()
    val httpHelper = retrofit.create(HttpHelper::class.java)
    return httpHelper.deleteLeaseLoggingCheckControllerByIdIssuer(id)
}
...
internal fun deleteRequirementThirdLoggingCheckByIdIssuer(id:String):Observable<ResponseBody>{
    val interceptor = Interceptor {
        it.proceed(it.request().newBuilder().addHeader("zouxiaodong",UnSerializeDataBase.userToken).build())
    }
    val client = OkHttpClient.Builder().addInterceptor(interceptor).build()
    val retrofit =  Retrofit.Builder().client(client).baseUrl(UnSerializeDataBase.dmsBasePath).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build()
    val httpHelper = retrofit.create(HttpHelper::class.java)
    return httpHelper.deleteRequirementThirdLoggingCheckByIdIssuer(id)
}

/**
 * @行业黄页
 */
internal fun deleteIndustryYellowPages(id:String):Observable<ResponseBody>{
    val interceptor = Interceptor {
        it.proceed(it.request().newBuilder().addHeader("zouxiaodong",UnSerializeDataBase.userToken).build())
    }
    val client = OkHttpClient.Builder().addInterceptor(interceptor).build()
    val retrofit =  Retrofit.Builder().client(client).baseUrl(UnSerializeDataBase.dmsBasePath).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build()
    val httpHelper = retrofit.create(HttpHelper::class.java)
    return httpHelper.deleteIndustryYellowPages(id)
}
