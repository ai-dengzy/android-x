 ...
 * @我的模块端口:8032
 * @学校服务器 10.1.5.141
 * @联通服务器 www.ycdlfw.com
 * @新服务器 111.230.150.200
 * @某人本地服务器 邦:192.168.1.132 赵:192.168.1.65
 */
...
//const val shoppingPath = "http://192.168.1.65:8022/"
  const val shoppingPath = "http://${ip}/shopping/"
  const val upmsBasePath = "http://${ip}/upms/"
  const val dmsBasePath = "http://${ip}/dms/"
  const val mineBasePath = "http://${ip}/mine/"
//  const val upmsBasePath = "http://192.168.1.65:8026/"
//  const val dmsBasePath = "http://192.168.1.65:8012/"
//  const val mineBasePath = "http://192.168.1.65:8032/"
  var userToken=""
  var cookie:String =""
  var userName:String=""
  ...
  var inventoryIdKey = ""
  var inventoryId = ""
  const val filePath = "/storage/emulated/0/ycdlfw"
